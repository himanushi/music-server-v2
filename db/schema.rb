...
ActiveRecord::Schema.define(version: 2021_10_23_000000) do
  ...
  create_table "album_tracks", id: { type: :string, limit: 16 }, charset: "utf8mb4", force: :cascade do |t|
    ...
    t.index ["album_id", "disc_number", "track_number"], name: "index_album_tracks_on_album_id_and_disc_number_and_track_number", unique: true
    t.index ["duration_ms"], name: "index_album_tracks_on_duration_ms"
    t.index ["name"], name: "index_album_tracks_on_name"
    t.index ["service_id"], name: "index_album_tracks_on_service_id"
    t.index ["track_id"], name: "fk_rails_3873b3f5c0"
  end
  ...
  create_table "albums", id: { type: :string, limit: 16 }, charset: "utf8mb4", force: :cascade do |t|
    ...
    t.index ["service_id"], name: "index_albums_on_service_id", unique: true
  ...
  create_table "ignore_contents", id: { type: :string, limit: 16 }, charset: "utf8mb4", force: :cascade do |t|
    ...
    t.index ["service_id"], name: "index_ignore_contents_on_service_id", unique: true
  end
  ...
  create_table "service_artists", id: { type: :string, limit: 16 }, charset: "utf8mb4", force: :cascade do |t|
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.string "artist_id", limit: 16, null: false
    t.string "service_id", limit: 191, null: false
    t.string "name", limit: 191, null: false
    t.index ["artist_id"], name: "fk_rails_4a6f6f0df9"
    t.index ["name"], name: "index_service_artists_on_name"
    t.index ["service_id"], name: "index_service_artists_on_service_id", unique: true
  end
  ...
  add_foreign_key "service_artists", "artists"
